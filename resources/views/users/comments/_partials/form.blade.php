...
<div class="w-full bg-white shadow-md rounded px-8 py-12">
    ...
    <textarea name="body" cols="30" rows="10" placeholder="adicione o comentário"
    ...
    border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-block">
